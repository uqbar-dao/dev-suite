...
:ziggurat &ziggurat-action [%foo %start-pyro-ships ~]
:ziggurat &ziggurat-action [%foo %queue-test `%setup setup]

:ziggurat &ziggurat-action [%foo %queue-test `%scry-nec scry-nec]
:ziggurat &ziggurat-action [%foo %queue-test `%scry-bud scry-bud]
:ziggurat &ziggurat-action [%foo %queue-test `%scry-clay scry-clay]
:ziggurat &ziggurat-action [%foo %queue-test `%send-nec send-nec]
:ziggurat &ziggurat-action [%foo %queue-test `%send-nec-custom send-nec-custom]
